...
export default function ResultsPage() {
    ...
    try {
      ...
      if (context) {
        ...
        toast({
          title: "이미지 캡쳐 완료",
          description:
            "이미지가 캡쳐되었습니다. 이제 캐리커처를 생성할 수 있습니다.",
        });
      }
    } catch (err) {
  ...
  const handleSavePdf = async () => {
    ...
    try {
      ...
      const stressLevelText = {
        낮음:
          pdfLanguage === "ko" ? "낮음" : pdfLanguage === "ja" ? "低い" : "Low",
        보통:
          pdfLanguage === "ko"
            ? "보통"
            : pdfLanguage === "ja"
      ...
      pdf.text(
        "● " + texts.heartRate + " & " + texts.stressLevel,
        margin,
        yPos
      );
      yPos += lineHeight + 2;
      ...
      pdf.text(
        texts.heartRate +
          ": " +
          (typeof currentResult.heartRate === "number"
            ? currentResult.heartRate.toFixed(1)
            : "0") +
          " BPM",
        margin + 10,
        yPos
      ...
      const splitHealthText = pdf.splitTextToSize(
        healthAnalysisText,
        contentWidth - 20
      );
      ...
      // 너무 긴 텍스트를 여러 줄로 분리
      const splitMoodText = pdf.splitTextToSize(
        moodTipsText,
        contentWidth - 20
      );
      ...
      if (currentResult.hrv) {
        ...
        const splitAnalysisText = pdf.splitTextToSize(
          translatedAnalysis,
          contentWidth - 40
        );
  ...
  const heartRate =
    typeof currentResult.heartRate === "number" ? currentResult.heartRate : 0;
  const confidence =
        ...
        <div className="flex items-center gap-2">
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end">
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem onClick={() => setPdfLanguage("ko")}>
                한국어
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setPdfLanguage("en")}>
                English
              </DropdownMenuItem>
              <DropdownMenuItem onClick={() => setPdfLanguage("ja")}>
                日本語
              </DropdownMenuItem>
            </DropdownMenuContent>
          </DropdownMenu>
              ...
              {currentResult.caricatureUrl ? (
                ...
                <div className="flex flex-col items-center text-center py-10">
                  ...
                  <p className="text-gray-500 mb-6">
                    표정 마스킹을 시작하고 이미지를 캡처하여 AI 캐리커처를
                    생성해보세요.
                  </p>
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-gray-500 text-xs mt-4">
                    ※ LF는 긴장·집중 모드를, HF는 휴식·회복 모드를 나타냅니다.
                    LF/HF 비율이 높으면 긴장·집중 모드가 상대적으로 활성화된
                    상태입니다.
                  </p>
                </CardContent>
              </Card>
                ...
                <Table>
                  ...
                  <TableBody>
                    ...
                    <TableRow>
                      ...
                      <TableCell>
                        긴장과 휴식이 어느 쪽으로 기울었는지 한눈에 보는 저울값
                      </TableCell>
                    </TableRow>
                    <TableRow>
